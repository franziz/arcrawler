...
class Crawler(Template):
	...
	LAST_PAGE_XPATH = "(//div[@class='pagination']/span/a)[last()]/@href"
	PREV_XPATH = "//div[@class='pagination']/span/strong/preceding-sibling::a[1]/@href"
	POST_XPATH = "//div[re:test(@id,'p[0-9]{3,}')]"
	FIELDS = [
		{"published_date": {
			"single": True,
			"data_type": "date",
		...
		{"permalink": {
			...
			"data_type": "url",
			"concat": False,
			"xpath": "concat('forum/',.//span[@class='vtdate']/a/@href)"
		}},
		{"title":{
			"single":True,
			"data_type": "string",
