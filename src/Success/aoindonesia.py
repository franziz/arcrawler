...
class Crawler(Template):
	...
	LINK_TO_CRAWL = [
		...
		"http://aoindonesia.net/forums/japan-information.36/",
		"http://aoindonesia.net/forums/japan-today.56/",
		"http://aoindonesia.net/forums/nihongo-no-kaiwa-no-kiso.18/",				
		"http://aoindonesia.net/forums/world-creation.156/",						
		"http://aoindonesia.net/forums/aw-challenges.98/",
		...
		"http://aoindonesia.net/forums/galge-eroge-club-18.53/",				
		"http://aoindonesia.net/forums/tutorial.15/",		
		"http://aoindonesia.net/forums/introduce-yourself.37/"
	]
	COUNTRY = "IDN"
