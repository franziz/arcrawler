...
class Crawler(Template):
	...
	FIELDS = [ 
		{"published_date": {
			...
			"data_type": "date",
			"concat": False,
			"xpath": "concat(substring(concat(concat('20',substring-before(substring-after(substring-after(concat(.//span[@class='date']/text(),.//span[@class='time']/text()),'-'),'-'),',')),'/',substring-before(substring-after(concat(.//span[@class='date']/text(),.//span[@class='time']/text()),'-'),'-'),'/',substring-before(concat(.//span[@class='date']/text(),.//span[@class='time']/text()),'-'),' ',substring-after(substring-after(substring-after(concat(.//span[@class='date']/text(),.//span[@class='time']/text()),'-'),'-'),',')),1 div contains(concat(.//span[@class='date']/text(),.//span[@class='time']/text()),'-')),substring(concat(.//span[@class='date']/text(),.//span[@class='time']/text()),1 div not(contains(concat(.//span[@class='date']/text(),.//span[@class='time']/text()),'-'))))"
		}},
		{"author_name":{
			"single":True,
			"data_type": "string",
